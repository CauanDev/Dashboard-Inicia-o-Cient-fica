...
const cidades = [
    ...
    'Itaporã', 'Itaquirai', 'Ivinhema', 'Japorã', 'Jaraguari', 'Jardim', 'Jateí',
    ...
    'Rochedo', 'Santa Rita do Pardo', 'São Gabriel do Oeste', 'Sete Quedas',
    'Selvíria', 'Sidrolândia', 'Sonora', 'Tacuru', 'Taquarussu', 'Terenos',
